...
Once, this is done, we would like to create a new layer with one single feature/polygon representing the contour of the area formed by 5 communes selected. This transformation is called **dissolving**. 
